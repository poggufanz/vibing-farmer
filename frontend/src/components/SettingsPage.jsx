      ...
      <div style={{ maxWidth: 820, margin: '0 auto', width: '100%' }}>
          ...
          <div style={{ marginBottom: 6 }}>
            ...
            >
              <span
                ...
                style={{ borderColor: !agentSettings.emergencyFull ? 'var(--accent)' : undefined }}
              >
        ...
        <Section title="Vault Strategy">
          <Row
            label="Active Skill"
            desc={
              customSkill ? 'Custom strategy · user-defined' : 'Default Strategy by Vibing Farmer'
            }
          >
          ...
          <Radio
            ...
            desc="Venice AI when wallet-authorized, else server proxy"
          />
          <Radio
            sel={s.modelPreference === 'venice'}
            onClick={() => set('modelPreference', 'venice')}
            title="Venice AI"
            desc="x402 wallet payment (SIWE) · needs connected wallet + prepaid USDC on Base"
          />
          <Row
            label="Venice API Key"
            desc="Routes strategy to api.venice.ai (Bearer auth). Alternative to the x402 wallet path — not required for it. Stored locally, never sent to our servers."
          >
            <span />
          </Row>
          <ApiKeyField
